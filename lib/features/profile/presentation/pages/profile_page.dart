      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Status Kandungan', profile.statusKandungan ?? '-'),
            _buildInfoRow('Pendapatan Keluarga', profile.pendapatanKeluarga ?? '-'),
            _buildInfoRow('Provinsi', profile.provinsi ?? '-'),
            _buildInfoRow('Kota/Kabupaten', profile.kota ?? '-'),
            _buildInfoRow('Kecamatan', profile.kecamatan ?? '-'),
          ],
        ),
      ),
    );

...
class DailyTasksSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return asyncProgress.when(
      ...
      data: (progress) {
        final autoTasks = progress.tasks
            .where((t) => t.isAuto || t.taskType.startsWith('feature_'))
            .toList();
        ...
        final completedCount = autoTasks.where((t) => t.isCompleted).length;
        final totalCount = autoTasks.length;
